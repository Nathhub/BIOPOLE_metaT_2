...
ggplot(diversity_df, aes(depth, richness, fill = depth)) +
  geom_col() +
  facet_wrap(~station) +
  theme_minimal(base_size = 13) +
  labs(
    title = "KO functional richness by station and depth",
    y = "Number of detected KOs",
    x = NULL
  ) +
